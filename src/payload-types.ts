...
export interface Config {
  ...
  collectionsSelect: {
    ...
    newpage: NewpageSelect<false> | NewpageSelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "newpage_select".
 */
export interface NewpageSelect<T extends boolean = true> {
  title?: T;
  hero?:
    | T
    | {
